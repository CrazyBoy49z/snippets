(function() {
    ...
    if(figcap){
        ...
        if (imgCount > 1) {
            ...
            galleryStart.innerText = "vergrößern";
    ...
    function albisGallery() {
        ...
        // sizes definieren
        var sizes = 'sizes="(max-width: 300px) 300px, (max-width: 450px) 450px, (max-width: 600px) 600px, (max-width: 900px) 900px, (max-width: 1200px) 1200px, (max-width: 1800px) 1800px"';
